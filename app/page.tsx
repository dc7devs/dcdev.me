...
import { allMasteries } from "contentlayer/generated";
  ...
  return (
    <div className={"sm:w-full sm:h-full flex sm:m-0 sm:items-center"}>
        <div className="flex flex-col gap-5">
          ...
          {allMasteries[0].skills && <>
            <small className="my-3 font-montserrat"><strong>Habilidades</strong></small>
            
            <div className="inline-flex flex-wrap gap-1">{allMasteries[0]?.skills?.map((masteryData: any, index) => {
                return (
                  <MasteryPopover key={index} {...masteryData}>
