...
export default function Page() {
  return (
    <div
      className={
        'flex w-full flex-col gap-14 pt-20 sm:pt-10 lg:mx-auto lg:max-w-6xl'
      }
    >
      <section className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_24rem] lg:items-start">
        <div className="prose prose-zinc dark:prose-invert prose-p:my-3 prose-p:leading-normal flex h-full w-auto flex-col">
          <div>
      ...
      <section className="prose prose-zinc dark:prose-invert prose-p:my-3 prose-p:leading-normal w-full">
        <small className="mt-4 mb-4 inline-flex items-center gap-1">
          <FluentEmojiHighContrastMagnifyingGlassTiltedLeft />
  ...
  return (
    <>
      ...
      <p className="align-baseline">
        ...
        progress and what I&#39;m building next.
      </p>
