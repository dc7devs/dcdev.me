---
title: "dcdevs"
description: "In Nuxt 3, we introduced first-class support for Vite as bundler, interchangeable with Webpack (also available in Nuxt 2 with Bridge). Since Vite provides an incredibly fast developer experience, we had to make sure SSR works as fast."
...
video: "https://res.cloudinary.com/dyxtcsnna/video/upload/v1714345211/dcdev/SPRING_SECURITY_JWT_knewl9.mp4"
