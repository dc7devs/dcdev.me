...
export default function Home() {
  return (
    <Layout>
      <div className={cx("sm:w-full sm:h-full flex mt-24 sm:m-0 sm:items-center", poppins.className)}>
        <div className="flex flex-col gap-5 px-4">
          ...
          <p className="md:w-9/12 leading-loose">Aqui você encontrará alguns dos meus projetos mais recentes como <strong>desenvolvedor full-stack</strong>, alguns projetos de estudo outros tendente a incrível, alguns rascunhos e também um pouco sobre mim.</p>
          <p className="align-baseline">
          ...
          <button className="max-w-max h-8 px-2 font-regular rounded-lg bg-black/25 dark:bg-white/25 dark:border-1 md:shadow-sm hover:shadow-violet-500/25 bakcdrop-blur ring-4 dark:ring-2 ring-violet-300/10 border border-transparent hover:transition-colors hover:ease-in hover:border-zinc-700 dark:hover:border-white/50">
            <Link href="/about">
